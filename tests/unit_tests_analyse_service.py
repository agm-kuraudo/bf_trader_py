...
class TestMarketAnalyser(unittest.TestCase):
    ...
    def test_get_market_data(self):
        ...
        self.mock_db_connection.db_read.return_value = [
            (
                "2025-03-01 12:00:00",
                "1.240323372",
                "runner1",
                "{'availableToBack': [{'price': 2.0}], 'availableToLay': [{'price': 2.2}]}",
            )
        ]
    ...
    def test_process_data(self):
        raw_data_points = [
            (
                ...
                "1.240323372",
                "runner1",
                "{'availableToBack': [{'price': 2.0}, {'price': 2.1}, {'price': 2.2}], 'availableToLay': [{'price': 2.3}, {'price': 2.4}, {'price': 2.5}]}",  # noqa: E501
            ),
            (
                "2025-03-01 12:05:00",
                "1.240323372",
                "runner2",
                "{'availableToBack': [{'price': 3.0}, {'price': 3.1}, {'price': 3.2}], 'availableToLay': [{'price': 3.3}, {'price': 3.4}, {'price': 3.5}]}",  # noqa: E501
            ),
        ]
