...
$dockerCommand = "docker run --name some-rundeck -e vault_unseal_keys='$envVar' -p 4440:4440 -v $scriptDir/run_deck_data:/home/rundeck/server/data -v ${localFolder}:/home/rundeck/app -e DOCKER_HOST=tcp://host.docker.internal:2375 agm-karaudo/rundeck-image-01"
