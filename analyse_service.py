...
class MarketAnalyser:
    ...
    def get_runners(self):
        try:
            ...
            Log.log_info(f"List of Runners: {runners_list}")
    ...
    def get_market_data(self):
        if self.start_time and self.end_time:
            query = f"SELECT \"timestamp\", market_id, runner_id, odds FROM bf.market_table where market_id='{self.market_id}' AND \"timestamp\" BETWEEN '{self.start_time}' AND '{self.end_time}';"  # noqa: E501
        else:
            query = f"SELECT \"timestamp\", market_id, runner_id, odds FROM bf.market_table where market_id='{self.market_id}';"  # noqa: E501
